...
def create_sub_agent_delegate() -> Agent:
    ...
    return Agent(
        role="Chores Tracker Backend Knowledge specialist Coordinator",
        goal="Delegate queries to the Chores Tracker Backend Knowledge specialist sub-agent and return results.",
        backstory=(
