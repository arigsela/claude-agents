...
AI agent with deep knowledge of the Chores Tracker application for answering questions about architecture, API, deployment, and troubleshooting
...
- **Chores Tracker Backend Specialist** (port 8080): Answer questions about the Chores Tracker app architecture, FastAPI backend, PostgreSQL database, API endpoints, deployment, and troubleshooting using knowledge sources and tools.
