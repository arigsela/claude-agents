...
#   uvicorn backend-agent.server:app --host 0.0.0.0 --port 8080
# ==============================================================================
...
logger = setup_logging("backend-agent.server")
...
AGENT_CARD = AgentCard(
    name="Chores Tracker Backend Specialist",
    description="Answer questions about the Chores Tracker app architecture, FastAPI backend, PostgreSQL database, API endpoints, deployment, and troubleshooting using knowledge sources and tools.",
...
def create_app() -> FastAPI:
    ...
    application = FastAPI(
        title=f"{PROJECT_NAME} - Chores Tracker Backend Specialist",
        version="1.0.0",
    )
