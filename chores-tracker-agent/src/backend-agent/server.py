...
AGENT_CARD = AgentCard(
    ...
    description="Answer questions about the Chores Tracker backend — FastAPI endpoints, PostgreSQL schema, Alembic migrations, deployment pipelines, and troubleshooting",
