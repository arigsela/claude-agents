...
from test-agent.tools import search_knowledge, get_system_info, check_health
...
class TestSubAgentServer:
    ...
    def test_health_endpoint(self):
        ...
        from test-agent.server import app
...
class TestAgentCreation:
    ...
    def test_agent_has_tools(self):
        ...
        with patch("test-agent.agent.LLM"):
            from test-agent.agent import create_agent
            agent = create_agent()
