...
#   uvicorn test-agent.server:app --host 0.0.0.0 --port 8080
# ==============================================================================
...
logger = setup_logging("test-agent.server")
...
def create_app() -> FastAPI:
    ...
    application = FastAPI(
        title=f"{PROJECT_NAME} - Test Agent",
        version="1.0.0",
    )
    ...
    from test-agent.executor import SubAgentExecutor
