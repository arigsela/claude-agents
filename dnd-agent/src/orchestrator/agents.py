...
def create_sub_agent_delegate() -> Agent:
    ...
    return Agent(
        role="Dungeons and Dragons Character creation/knowledge specialist Coordinator",
        goal="Delegate queries to the Dungeons and Dragons Character creation/knowledge specialist sub-agent and return results.",
        backstory=(
