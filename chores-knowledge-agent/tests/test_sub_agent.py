...
from knowledge-agent.tools import search_knowledge, get_system_info, check_health
...
class TestSubAgentServer:
    ...
    def test_health_endpoint(self):
        ...
        from knowledge-agent.server import app
...
class TestAgentCreation:
    ...
    def test_agent_has_tools(self):
        ...
        with patch("knowledge-agent.agent.LLM"):
            from knowledge-agent.agent import create_agent
            agent = create_agent()
