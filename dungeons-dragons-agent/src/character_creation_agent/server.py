...
#   uvicorn character_creation_agent.server:app --host 0.0.0.0 --port 8080
# ==============================================================================
...
logger = setup_logging("character_creation_agent.server")
...
AGENT_CARD = AgentCard(
    ...
    description="Answer questions related to character creation or suggestions for dungeons and dragons 5e",
...
def create_app() -> FastAPI:
    ...
    application = FastAPI(
        title=f"{PROJECT_NAME} - Character Creation Agent",
        version="1.0.0",
    )
    ...
    async def health():
        return {"status": "healthy", "service": "character_creation_agent"}
    ...
    from character_creation_agent.executor import SubAgentExecutor
