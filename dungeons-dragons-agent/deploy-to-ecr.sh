...
SERVICES=(
    "dungeons-dragons-agent-orchestrator:docker/Dockerfile.orchestrator"
    "dungeons-dragons-agent-character-creation-agent:docker/Dockerfile.character_creation_agent"
)
