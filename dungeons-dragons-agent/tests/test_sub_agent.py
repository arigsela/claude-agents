...
from character_creation_agent.tools import search_knowledge, get_system_info, check_health
...
class TestSubAgentServer:
    ...
    def test_health_endpoint(self):
        ...
        from character_creation_agent.server import app
...
class TestAgentCreation:
    ...
    def test_agent_has_tools(self):
        ...
        with patch("character_creation_agent.agent.LLM"):
            from character_creation_agent.agent import create_agent
            agent = create_agent()
